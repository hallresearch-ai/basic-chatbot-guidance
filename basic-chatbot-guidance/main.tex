...
\setbeamertemplate{footline}{
  ...
  \hbox{
    \begin{beamercolorbox}[wd=.5\paperwidth,ht=3ex,dp=1ex,left]{author in head/foot}
      \hspace{0.8ex}{\includegraphics[height=0.7cm]{img/logo.png}}
    \end{beamercolorbox}%
...
\begin{columns}[T,onlytextwidth]
    ...
    \begin{itemize}
        ...
        \item Use \href{https://github.com/hallresearch-ai/basic-chatbot-guidance/blob/main/prompt-library/llm-as-a-judge-response-rubric.txt}{rubrics} with calibration.
